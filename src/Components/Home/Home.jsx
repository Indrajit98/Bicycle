        ...
        <div className="grid md:grid-cols-2 grid-cols-1 gap-5" >
            {
                products?.map((product,i) => <div key={i}>
                    <div className="card shadow-xl p-4" data-aos="fade-up-left">
                        <figure><img src={product.picture} alt="Shoes" className="w-full h-80 object-contain justify-center items-center" /></figure>
                        <div className="card-body">
                            ...
                            <div className='flex items-center'>
                                ...
                                <div className=" text-success w-4 pl-1"><FaRegCheckCircle></FaRegCheckCircle></div>
                            </div>
